...
func TestRun(t *testing.T) {
	var testCases = []struct {
		...
		{name: "successPush", proj: "../gocitestdata/tool/",
			out: "Git Push: SUCCESS\n", expErr: nil,
		},
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			//success case : err is nil & expErr is nil

			//fail case: expErr is not nil & err is not nil
			//expErr should be eq err
			if tc.expErr != nil {
				if err == nil {
